    ...
    return (
        <div>
            <div className="absolute inset-0">
                <img src="/assets/images/sign_bg_img.jpg" alt="image" className="h-full w-full object-cover" />
            </div>

            <div className="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/sign_bg_img.jpg)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16 ">
                <img src="/assets/images/sign_bg_img.jpg" alt="image" className="absolute " />
