...
const CorporateGovernance = () => {
    ...
    const getData = async () => {
        try {
            ...
            const datas = separatedData['3696'];
            const tableData =
                datas?.map((item) => ({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res: any = await axios.post(`https://file.kprmilllimited.com/wp-json/contact-form-7/v1/contact-forms/3696/feedback`, formData, {
                headers: {
        ...
        showDeleteAlert(
            async () => {
                try {
                    ...
                    const config = {
                        method: 'delete',
                        url: `https://file.kprmilllimited.com/wp-json/cf7-api/v1/forms/3696/submissions/${record.id}`,
                        headers: {
                            'Content-Type': 'multipart/form-data',
                            Authorization: `Bearer ${token}`,
                        },
